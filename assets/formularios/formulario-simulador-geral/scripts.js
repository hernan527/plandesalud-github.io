(function (jQuery) {
	...
	jQuery(document).ready(function(){
		...
		jQuery("#form").validate({
			...
			messages:{
				idTipo:{required: "Seleccione una opción"},
				possuiCNPJ:{required: "Seleccione una opción"},
				possuiPlano:{required: "Seleccione una opción"},
				nome:{required: "El campo Nombre es necesario"},
				email:{required: "El campo Nombre es necesario",email: "Informe u EMAIL válido"},
				Prefijo:{required: "El campo Nombre es necesario"},
				telefone:{required: "El campo Nombre es necesario"}
			},
