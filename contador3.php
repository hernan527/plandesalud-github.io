...
// CONEXION MYSQL
$host_db = "localhost";
// $mysqli = new mysqli('localhost', 'plan_herny', 'eritos', 'plan_basededatos');
...
if (empty($type)) {
  ...
  $query = "INSERT INTO contador (ip, host, navegador, ciudad, pais, cp, latitud, longitud, time, fecha, usuario, web, pagina, type) 
  VALUES ('$ipadress', '$hostname', '$useragent', '$ciudad', '$pais', '$cp', '$latitud', '$longitud', '$time', NOW(),'$usuario', '$web', '$pagina', '$type')";
}
...
$daily_visits = $row_daily_visits[$current_date];
