...
<style>
/* Cambiar el color del borde del campo y el color del texto cuando está en estado inválido */
.form-control:invalid {
  border-color: rgba(255, 0, 0, 0.65); /* Color rojo para el borde */
  color: rgba(255, 0, 0, 0.65); /* Color rojo para el texto */
}

/* Cambiar el color del fondo del campo cuando está en estado inválido */
.form-control:invalid:focus {
  background-color: rgba(255, 0, 0, 0.1); /* Color rojo tenue para el fondo */
}

/* Cambiar el color del placeholder del campo cuando está en estado inválido */
.form-control:invalid::-webkit-input-placeholder {
  color: rgba(255, 0, 0, 0.65); /* Color rojo para el placeholder */
}

/* Otros prefijos de navegadores */
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11164676710"></script>
<script>
...
<div id="mensaje-validacion" style="display: none; background-color: #ffcccc; padding: 10px;">
...
<!-- Agrega una imagen oculta que cargará el script contador.php -->
    ...
    <div class='banner-desktop' style='background-image: url(../assets/imagenes/banners/banner-cotea-gora.jpg)'><div class='corpo-banner'><p><strong>Ahorre hasta un 30% en un nuevo plan.</strong><br />
        <em>Cotiza ya!<br/>
        en más de 50 planes</em></p>
        <a href='#1'  class="smooth-scroll">COTIZAR AHORA</a></div></div><div class='banner-mobile' style='background-image: url()'><div class='corpo-banner'><p><strong>Ahorre hasta un 30% en un nuevo plan.</strong><br />
        <em>Cotiza ya!<br />
        en más de 50 planes</em></p>
		<a  href='#1'  class="smooth-scroll">COTIZAR AHORA</a>
        </div></div>
        <div id="wrapper">
    ...
    <article class="post" id="post-16">
        ...
        <div class="entry">
            ...
            <div class="conteudo-da-pagina">
                            ...
                            <div class="bandeiras" >
                     <img href="3" src="../assets/imagenes/logos-prepagas-190x110/todas-las-empresas.png" alt="Todos los Planes de Salud" title="Todos los Planes de Salud" data-id-operadora="Todos Los Planes" onclick="cambiarValor('Todos')" data-classe-operadora="multimarcas">
...
<div   class="datos-contacto" id="datos-contacto">
		...
		<span><i>Nombre Completo</i><input  autocomplete="off" class="campo-nome" type="text" name="Name"  id="Name"  placeholder="Su nombre" required=""></span>
		<div class="telefono">
	...
	<div>
		...
		<span><i>E-mail</i><input  autocomplete="off" class="campo-email" type="email"  id="email" name="email" placeholder="Ej: cotizar@plandesalud.ar" required=""></span>
		</div>
        <div class="alert"></div>
        <input type="submit" id="boton-enviar" onclick="finalizar('.form-cotacao')" value="RECIBIR COTIZACIÓN">
		<br><br><br>
                                ...
                                <div class="corpo">
                                    ...
                                    <div class="elementos" id="2">
                                        <div class="plantao">
                                            ...
                                            <a href="tel:01125608600"><img src="../formularios/formulario-whatsapp/icone-telefone.svg"> (11) 2560-8600</a>
                                           ...
                                           <form href='#2' id="contact-form-whats" class="form-whats" action="../includes/form-contacto.php" method="post">
                                            ...
                                            <input type="submit" onclick="finalizarWhats('.form-whats')" value="SOLICITAR COTIZACIÓN">
                                            <div class="loaderwhats" style="display: none;"></div>
...
<script>
    ...
    <span><div class="barra-rodape-mobile "></span>
