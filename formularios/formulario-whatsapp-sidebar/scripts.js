(function (jQuery) {
    ...
    jQuery(document).ready(function(){
        ...
        jQuery("#form-whats").validate({
            ...
            rules:{nome:{required: true},Prefijo:{required: true,rangelength: [2,3]},telefone:{required: true,minlength: 9}},
            messages:{nome:{required: "El campo Nombre es necesario"},Prefijo:{required: "O campo Prefijo é obrigatório"},telefone:{required: "O campo TELEFONE é obrigatório"}},
            ...
            submitHandler: function(form){
                ...
                if(formErro ==0){
                    ...
                    jQuery.ajax({
                        url : '/formularios/formulario-whatsapp-sidebar/EnvioFormWhats.php',
                        type : 'POST',
                        data : dados,
                        dataType : 'json',
                        success : function(x){
                            ...
                            if (x.resp == 'success') {
                                jQuery('#form-whats.form-whats-sidebar').html('<span class="sucesso">ENVIO EXITOSO!</span>');
