...
$ID_Formulario = $_POST['ID-formulario'];
$Nombre = $_POST['name'];
...
try {
    function googleForm() {
        $url = 'https://docs.google.com/forms/d/e/1FAIpQLSc5RIe9EMxsr9XVT9aUjc-z1S--ce73BPFxgcQS4Ddz675Olg/formResponse';
        ...
        //   $Prefijo = $_POST['prefijo'];
                 ...
                 $data = array(
            'entry.1125470886' => $ID_Formulario,
            'entry.190212797' => $Nombre,
            'entry.1039497839' => $Telefono,
            'entry.619759567' => $Prefijo,
          );
    ...
    $message .= "<tr style='background: #eee;'><td><strong>|ID_Formulario|</strong></td><td>" . strip_tags($ID_Formulario) . "</td></tr>";
    $message .= "<tr style='background: #eee;'><td><strong>Nombre:</strong></td><td>" . strip_tags($Nombre) . "</td></tr>";
    // $message .= "<tr><td><strong>Prefijo</strong></td><td>" . strip_tags($Prefijo) . "</td></tr>";
