...
<link href="./assets/css/style-formularioSimuladorGeneral.css" rel="stylesheet" type="text/css">
    ...
    <meta property="og:image" content="https://www.plandesalud.ar/assets/imagenes/banners/happy-parents-with-two-children-summer-1920-520.png" />
                        ...
                        <div class="wp-block-group__inner-container">
                            ...
                            <div class="logos">
                                <a href="planes-de-salud-precios/hominis-plan-de-salud/index.html">
                                    <img src="./assets/imagenes/logos-prepagas-190x110/hominis-logo-medicina-prepaga-planes-de-salud.png" alt="Hominis" title="Hominis" loading="lazy">
                                </a>
                                ...
                                <a href="planes-de-salud-precios/salud-central-plan-de-salud/index.html">
                                    <img src="./assets/imagenes/logos-prepagas-190x110/salud-central-logo-medicina-prepaga-planes-de-salud.png" alt="Salud Central" title="Salud Central" loading="lazy">
                                </a>
                                ...
                                <a href="planes-de-salud-precios/doctored-plan-de-salud/index.html">
                                    <img src="./assets/imagenes/logos-prepagas-190x110/doctored-logo-medicina-prepaga-planes-de-salud.gif" alt="Doctored" title="Doctored" loading="lazy">
                                </a>
                                <a href="planes-de-salud-precios/avalian-plan-de-salud/index.html">
                                    <img src="./assets/imagenes/logos-prepagas-190x110/avalian-logo-medicina-prepaga-planes-de-salud.png" alt="Avalian" title="Avalian" loading="lazy">
                                </a>
                                <a href="planes-de-salud-precios/prevencion_salud-plan-de-salud/index.html">
                                    <img src="./assets/imagenes/logos-prepagas-190x110/prevencion-salud-logo-medicina-prepaga-planes-de-salud.png" alt="Prevencion Salud" title="Prevencion Salud" loading="lazy">
                                </a>
                            </div>
                        </div>
                    </div>
 ...
 <h2 id="d"   class="passo-formulario"  >2º Completá el formulario</h2>
                    <form id="contact-form" class="form-cotacao">
                        ...
                        <div class="row edades">
                            <p class="edad-solo"><strong>Edad</strong></p>
                            <p class="edad-varios"><strong>Edades</strong></p>
                            <div class="col-6 edad_1">
                                <span class="span-alineado">
                                    <input class="campo-edad" type="tel" id="edad_1" name="edad_1" placeholder="Tu edad" required>
                                </span>
                            </div>
                            <div class="col-6 edad_2">
                                <span>
                                    <input class="campo-edad-pareja" type="tel" id="edad_2" name="edad_2" placeholder="Edad pareja">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="hijos_num">
                                <p><strong>¿Cuántos hijos ingresan al plan?</strong></p>
                                <div class="col-4">
                                    <span>
                                        <input class="campo-edades-hijos" type="tel" id="hijos_num" name="hijos_num" placeholder="Cantidad de hijos">
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="possui-cnpj">
                            ...
                            <label><input type="radio" id="rel-os" name="cualOS" value="Empleado"> <b class="btn-rel-os">Relación de dependencia</b></label>
                            <label><input type="radio" id="mon-os" name="cualOS" value="Monotributo"> <b class="btn-mon-os">Monotributista</b></label>
                        </div>

                        <div class="row sueldo">
                            <p><strong>Ingresa el importe de tu sueldo bruto (sin descuentos)</strong></p>
                            <span>
                                <input class="campo-sueldo" type="tel" name="sueldo" id="sueldo" placeholder="Ej: 350000">
                            </span>
                        </div>
                        ...
                        <div class="row monotributo">
                            <div class="col-6">
                                <span>
                                    <input class="campo-categoria-mon" type="text" name="categoriaMono" id="categoriaMono" placeholder="Categoría Monotributo">
                                </span>
                            </div>
                            <div class="col-6">
                                <span>
                                    <input class="campo-cant-aport-mon" type="text" name="aportantesMono" id="aportantesMono" placeholder="Cantidad de Aportantes">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="datos-contacto" id="datos-contacto">
                            ...
                            <span>
                                <i>E-mail</i>
                                <input class="campo-email" type="email" id="email" name="email" placeholder="tuemail@ejemplo.com" required>
                            </span>
                        </div>
        ...
        <div>
            <div class="col">
                <a class="logo" href="index.php">
                    <img src="./assets/imagenes/logos-web/plan-de-salud-vos-te-mereces-lo-mejor-logo-movil.png" alt="Plan de Salud" title="Plan de Salud">
                </a>
